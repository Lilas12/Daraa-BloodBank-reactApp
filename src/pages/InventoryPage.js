...
// //                 <td>
// //                   <ProgressBar>
// //                     <Progress width={percentage} color={item.color} />
// //                   </ProgressBar>
// //                 </td>
...
// function AutonomousInventory() {
//   const [inventory, setInventory] = useState([
//     { id: 1, bloodType: "A+", quantity: 50, color: "#4caf50" },
//     { id: 2, bloodType: "O-", quantity: 25, color: "#4caf50" },
//     { id: 3, bloodType: "B+", quantity: 40, color: "#4caf50" },
//     { id: 4, bloodType: "AB+", quantity: 60, color: "#4caf50" },
//   ]);

//   // محاكاة وصول بيانات من قاعدة البيانات (تحديث تلقائي)
//   useEffect(() => {
//     const interval = setInterval(() => {
//       setInventory((prev) =>
//         prev.map((item) => {
//           // تغيير عشوائي للكمية (زيادة أو نقصان) لمحاكاة الواقع
//           const change = Math.floor(Math.random() * 5) - 2;
//           const newQty = Math.max(0, Math.min(100, item.quantity + change));
//           const newColor = newQty < 25 ? "#f44336" : "#4caf50";
//           return { ...item, quantity: newQty, color: newColor };
//         })
//       );
//     }, 3000); // يتحدث كل 3 ثوانٍ
...
//       <HeaderSection>
//         <TitleGroup>
//           <h1>رصد المخزون المباشر</h1>
//           <StatusIndicator>
//             <span className="dot"></span>
//             متصل بقاعدة البيانات (تحديث لحظي)
//           </StatusIndicator>
//         </TitleGroup>
//       </HeaderSection>
...
//         <AnimatePresence>
//           {inventory.map((item) => {
//             const isCritical = item.quantity < 25;
//             return (
//               <BloodCard
//                 key={item.id}
//                 critical={isCritical}
...
//               >
//                 <CardTop>
//                   <BloodType color={item.color}>
//                     <FaTint />
//                     <span>{item.bloodType}</span>
//                   </BloodType>
//                   <Badge critical={isCritical}>
//                     {isCritical ? "نقص حاد" : "مستقر"}
//                   </Badge>
//                 </CardTop>

//                 <MainValue critical={isCritical}>
//                   {item.quantity}
//                   <small>وحدة</small>
//                 </MainValue>

//                 <ProgressWrapper>
//                   <ProgressLabel>سعة المخزون</ProgressLabel>
//                   <BarContainer>
//                     <BarFill width={item.quantity} color={item.color} />
//                   </BarContainer>
//                 </ProgressWrapper>

//                 {isCritical && (
//                   <WarningMessage>
//                     <FaExclamationCircle /> تنبيه: المخزون أوشك على النفاد
//                   </WarningMessage>
//                 )}
//               </BloodCard>
//             );
...
// export default AutonomousInventory;

// /* ======================
//    تنسيقات التصميم الذكي
// ====================== */
...
//   0% { border-color: #f44336; box-shadow: 0 0 0 0 rgba(244, 67, 54, 0.2); }
//   50% { border-color: #ffcdd2; box-shadow: 0 0 0 10px rgba(244, 67, 54, 0); }
//   100% { border-color: #f44336; box-shadow: 0 0 0 0 rgba(244, 67, 54, 0); }
// `;
...
//   padding: 25px;
//   border-radius: 24px;
//   border: 2px solid ${(props) => (props.critical ? "#f44336" : "#eee")};
...
//   font-size: 0.7rem;
//   font-weight: bold;
//   background: ${(props) => (props.critical ? "#fee2e2" : "#dcfce7")};
//   color: ${(props) => (props.critical ? "#dc2626" : "#16a34a")};
// `;

// const MainValue = styled.div`
//   font-size: 3.5rem;
//   font-weight: 900;
//   color: ${(props) => (props.critical ? "#dc2626" : "#333")};
//   line-height: 1;
//   margin-bottom: 15px;
//   small {
//     font-size: 1rem;
